...
import ChrisFormPage from 'pages/CRUD/Chris/form/ChrisFormPage';
import ChrisTablePage from 'pages/CRUD/Chris/table/ChrisTablePage';
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route path={'/admin/chris'} exact component={ChrisTablePage} />
          <Route path={'/admin/chris/new'} exact component={ChrisFormPage} />
          <Route
            path={'/admin/chris/:id/edit'}
            exact
            component={ChrisFormPage}
          />
        </Switch>
        <Fab
          color='primary'
